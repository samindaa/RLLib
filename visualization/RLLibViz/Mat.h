...
public:
  ...
  Mat(double const& m00, double const& m10, double const& m20, double const& m30, double const& m01,
      double const& m11, double const& m21, double const& m31, double const& m02, double const& m12,
      double const& m22, double const& m32, double const& m03, double const& m13, double const& m23,
      double const& m33)
  {
...
inline Mat matrixCompMult(const Mat& A, const Mat& B)
{
  return Mat(A[0][0] * B[0][0], A[0][1] * B[0][1], A[0][2] * B[0][2], A[0][3] * B[0][3],
      A[1][0] * B[1][0], A[1][1] * B[1][1], A[1][2] * B[1][2], A[1][3] * B[1][3], A[2][0] * B[2][0],
      A[2][1] * B[2][1], A[2][2] * B[2][2], A[2][3] * B[2][3], A[3][0] * B[3][0], A[3][1] * B[3][1],
...
inline Mat rotateX(double const& angle)
{
...
inline Mat rotateY(double const& angle)
{
  Mat c;
...
inline Mat rotateZ(double const& angle)
{
  Mat c;
...
inline Mat translate(double const& x, double const& y, double const& z)
{
  Mat c;
  c[0][3] = x;
  c[1][3] = y;
...
inline Mat translate(const Vec& v)
{
  return translate(v.x, v.y, v.z);
}

inline Mat scale(double const& x, double const& y, double const& z)
{
  Mat c;
  c[0][0] = x;
  c[1][1] = y;
