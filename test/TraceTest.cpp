...
{
  protected:
    typedef void (TraceTest::*testMethod)();
  ...
  public:
    ...
    {
      // register
      testMethods.push_back(&TraceTest::testATrace);
      testMethods.push_back(&TraceTest::testRTrace);
      testMethods.push_back(&TraceTest::testAMaxTrace);
      int methodCounter = 0;
