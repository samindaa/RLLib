...
void boundary_transformation_init(boundary_transformation_t *, double const *lower_bounds,
 ...
 * */
void boundary_transformation(boundary_transformation_t *, double const *x, double *y,
 ...
 * */
void boundary_transformation_inverse(boundary_transformation_t *t, double const *y, double *x,
